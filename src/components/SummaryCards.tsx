...
export default function SummaryCards({
  ...
  return (
    <Grid columns="repeat(auto-fit, minmax(250px, 1fr))" gap="1.5rem">
      ...
      {/* Net Worth Card */}
      <Card>
        <Text variant="h6" color="muted" className="mb-2">Total Net Worth</Text>
      ...
      <Card>
        <Text variant="h6" color="muted" className="mb-2">{year} Spending</Text>
        <Text variant="h2" weight="bold">
          {formatCurrency(yearlySpending)}
        </Text>
        <div className="mt-2">
          <Flex justify="space-between" className="mb-1">
            <Text variant="small">{spendingPercentage.toFixed(0)}% of budget</Text>
      ...
      <Card>
        <Text variant="h6" color="muted" className="mb-2">Upcoming Windfalls</Text>
              ...
              <Flex key={i} justify="space-between" align="center">
                <Flex direction="column">
                  ...
                  <Text variant="small" color="muted">
                    {new Date(windfall.date).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })} • {windfall.type}
                  </Text>
                </Flex>
