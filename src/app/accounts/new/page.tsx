    ...
    <Page>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        <Breadcrumbs className="mb-6">
          ...
          <BreadcrumbItem isCurrent>New Account</BreadcrumbItem>
        </Breadcrumbs>
            ...
            >
              ...
              >
                <Flex gap={4} align="center">
                  ...
                  <div>
                    <Text as="div" weight="bold" className="mb-1">
                      Manual Entry
                    </Text>
                    <Text as="div" variant="small" color="muted">
          ...
          {step === 2 && connectionType === "auto" && (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              <Text color="muted" align="center" className="mb-8">
                We are working on integrating with Plaid to allow automatic
                imports.
              </Text>
