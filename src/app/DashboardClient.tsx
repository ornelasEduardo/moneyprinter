...
export default function DashboardClient(props: DashboardClientProps) {
  ...
  const [selectedYear, setSelectedYear] = useState(props.selectedYear || currentYear);
  ...
  const generateProjections = () => {
    ...
    const monthsToStartOfYear = (selectedYear - currentYear) * 12 - currentMonth;
    ...
    if (recordedStartNetWorth !== undefined) {
      ...
      startOfYearNetWorth = props.netWorth + (monthsToStartOfYear * props.monthlyNetWorthIncrease);
    }
    ...
    const monthlyData = monthNames.map((month, idx) => {
      ...
      const monthlyWindfallTotal = monthlyWindfalls.reduce((sum, w) => sum + w.amount, 0);
      ...
      const monthlyChange = props.monthlyNetWorthIncrease + monthlyWindfallTotal + monthlyIncomeTotal - monthlyExpenseTotal;
          ...
          <TabsBody>
            <TabsContent value="home">
              ...
              <DashboardGrid>
                ...
                <Flex direction="column" gap="1.5rem" style={{ height: '100%', minWidth: 0 }}>
                  
                  {/* Net Worth Chart */}
                  <Card style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '400px', minWidth: 0 }}>
                    <Text variant="h5" color="muted" style={{ marginBottom: '1rem' }}>Net Worth Over Time</Text>
            ...
            <TabsContent value="budget">
              <Card style={{ padding: 0, overflow: 'hidden' }}>
                {/* Header */}
                <div style={{ padding: '1.5rem', borderBottom: 'var(--border-width) solid var(--card-border)' }}>
                  <Text variant="h3" weight="black">Budget</Text>
                  <Text color="muted">Manage your income streams and budget allocations</Text>
                </div>
